...
The [canvas.Raster](/api/v2/canvas/raster/#type--raster) is like an image but draws exactly one spot
...
Generating complete images (with [canvas.NewRaster()](/api/v2/canvas/raster/#func--newraster)) is more efficient
