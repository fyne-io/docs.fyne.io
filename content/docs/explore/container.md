...
As the [fyne.Container](/api/v2/fyne/container/#type--container) also is a [fyne.CanvasObject](/api/v2/fyne/canvasobject/#type--canvasobject), we can set it to be
the content of a [fyne.Canvas](/api/v2/fyne/canvas/#type--canvas). In this example we create 3 text objects
and then place them in a container using the [container.NewWithoutLayout()](/api/v2/container/pkg/#func--newwithoutlayout) function.
...
A [fyne.Layout](/api/v2/fyne/layout/#type--layout) implements a method for organising items within a container.
By uncommenting the [container.New()](/api/v2/container/apptabs/#func--new) line in this example you
