...
An entry can be created with a simple [widget.NewEntry()](/api/v2/widget/entry/#func--newentry)
...
field to a [fyne.StringValidator](/api/v2/fyne/stringvalidator/#type--stringvalidator). You can also set a `PlaceHolder`
